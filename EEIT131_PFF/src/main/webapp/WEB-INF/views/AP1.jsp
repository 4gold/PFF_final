...
<label><b>類別 :</b></label><select id='type'>
                           <option value='beef'>牛肉</option>
                           <option value='pork'>豬肉</option>
                           <option value='vegetable'>素食</option>
                           </select><br>
<label><b>熱量 :</b></label><input type='text' name='type' id='calories'></input><br>
<label><b>原料 :</b></label><input type='text' name='type' id='ingredients'></input><br>
<label><b>說明 :</b></label><input type='text' name='type' id='remarks'></input><br>
<label><b>上架 :</b></label><select id='onSale'>
                           <option value='true'>上架</option>
                           <option value='false'>下架</option>
                           </select><br>
<label><b>數量 :</b></label><input type='number' name='type' id='onStock'></input><br>
